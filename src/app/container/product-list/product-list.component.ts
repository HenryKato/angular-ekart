...
export class ProductListComponent {
  ...
  countAllProducts: number = this.products.length;
  countProductsInStock: number = this.products.filter(product => product.is_in_inventory).length;
  countProductsOutOfStock: number = this.countAllProducts - this.countProductsInStock;

  selectedRadioButtonValue: string = 'all';
  radioButtonValue(value: string) {
    this.selectedRadioButtonValue = value;
    console.log("Parent value " + this.selectedRadioButtonValue);
  }
}
